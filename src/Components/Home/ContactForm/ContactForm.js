...
const ContactForm = () => {
    return (
        <section id="contact-form" >
            ...
            <div id="form-div">
                <form action="http://localhost:5000/contact-us" method="POST" className="text-center " >
                    <input type="email" name="email" className="form-control" placeholder="E-mail Address*" required />
                    <br /><br />
                    <input type="text" name="subject" className="form-control" placeholder="Subject*" required />
                    <br /><br />
                    <textarea id="msg-area" name="message" className="form-control" placeholder="Your Message" style={{ resize: 'none', height: '150px' }} ></textarea>
                    <br /><br />
